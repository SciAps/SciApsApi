...
| /api/v2/config                                           | GET    | -                              | ZInstrumentConfig or           | Returns configuration info                                                |
|                                                          |        |                                | XInstrumentConfig or           |                                                                           |
|                                                          |        |                                | NInstrumentConfig              |                                                                           |
| /api/v2/status                                           | GET    | -                              | ZInstrumentStatus or           | Returns status info                                                       |
|                                                          |        |                                | XInstrumentStatus or           |                                                                           |
|                                                          |        |                                | NInstrumentStatus              |                                                                           |
...
| /api/v2/acquisitionParams/user?mode=[mode]               | GET    | -                              | ZAcquisitionSettings or        | Returns user acquisition settings for the given mode                      |
|                                                          |        |                                | XAcquisitionSettings or        |                                                                           |
| /api/v2/acquisitionParams                                | GET    |                                | NAcquisitionSettings           |                                                                           |
| /api/v2/acquisitionParams/user?mode=[mode]               | PUT    | ZAcquisitionSettings or        | -                              | Applies user acquisition settings for the given mode                      |
|                                                          |        | XAcquisitionSettings or        |                                |                                                                           |
...
| /api/v2/test/{spectra}?mode=[mode]&modelName=[modelName] | POST   | ZAcquisitionSettings or        | ZTestResult or                 | Runs a test using the given user acquisition settings                     |
|                                                          |        | XAcquisitionSettings           | XTestResult                    |                                                                           |
| /api/v2/acquisitionParams/factory?mode=[mode]            | GET    | -                              | ZFactoryAcquisitionSettings or | Returns factory acquisition settings for the given mode                   |
|                                                          |        |                                | XFactoryAcquisitionSettings    |                                                                           |
| /api/v2/acquisitionParams/factory?mode=[mode]            | PUT    | ZFactoryAcquisitionSettings or | -                              | Applies factory acquisition settings for the given mode                   |
|                                                          |        | XFactoryAcquisitionSettings    |                                |                                                                           |
...
| /api/v2/acquire/{spectra}?mode=[mode]                    | POST   | ZFactoryAcquisitionSettings or | ZAcquisitionResult or          | Acquire spectra using the given factory acquisition settings              |
|                                                          |        | XFactoryAcquisitionSettings    | XAcquisitionResult             |                                                                           |
